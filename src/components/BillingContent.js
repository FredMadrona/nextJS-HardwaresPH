...
const BillingContent = () => {
  ...
  const handleCreditCardInputChange = (e) => {
    ...
    // Dummy product data
    const products = [
    { name: 'Stainless Steel Bathroom Hardware', quantity: 1, price: 0.00 },
    { name: 'Stainless Steel Bathroom Hardware', quantity: 1, price: 0.00 },
    { name: 'Stainless Steel Bathroom Hardware', quantity: 1, price: 0.00 },
    ];
      ...
      <div className="col-span-5 lg:col-span-5 w-full lg:justify-start justify-center flex rounded p-5 space-y-5">
        <div className="bg-white rounded md:w-[100%] w-full p-5">
          <div className="border-b border-gray-300 pb-5">
            ...
            <span className= " text-gray-500"style={{ marginRight: '23em' }} >Item</span>
            ...
            {products.map((product, index) => (
              <div key={index} className="flex justify-between items-center mb-2">
                <p className="text-gray-500">{product.name} x {product.quantity}</p>
          ...
          <div>
            ...
            <div className="p-5 flex items-center">
                {/*Shipping choices*/}
                <div className="flex items-center mr-3"  style={{ marginRight: '50px' }}>
                    <input
                    type="radio"
                    name="shippingOption"
                ...
                <div className="w-full flex justify-center mt-1 p-3">
                  ...
                  <button className="bg-yellow-300 hover:bg-yellow-400 h-1/4 w-[48%] hover:shadow-md rounded mt-1 flex items-center justify-center border mr-2">
                    <Image src="/paypalpng.png" className="h-full w-auto m-3" height={50} width={50} alt="paypal" />
                  </button>
                </div>

                {/* Credit Card Payment button */}
                <div className="w-full flex justify-center mt-1 p-3">
                  <button onClick={handleCreditCardButtonClick} className="bg-black text-white hover:bg-gray-800 h-16 w-[48%] hover:shadow-md rounded mt-1 flex items-center justify-center border">
                    <span className="text-md font-bold">Credit Card Payment</span>
                  </button>
                </div>
                {/* Credit Card Dropdown */}
                <div className="pl-20"style={{ marginBottom: '20px', justifyContent: 'center' }}>
                  {showCreditCardDropdown && (
                    <div className="mt-4">
                      ...
                      <div style={{ marginBottom: '20px' }}>
                      <p className="text-gray-500 font-semibold">Expiration Date</p>
                        <div className="flex">
                          <select
                            name="expiryMonth"
                            className="text border border-gray-500 p-1 w-[40%] mr-2"
