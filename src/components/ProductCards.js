...
<Image src="/DoorControl.png"  width={100} height={100}  layout="responsive" className="rounded cursor-pointer hover:shadow-md "></Image>
          {/* <StaticImage
        ...
        <div className="col-span-1 m-5">
        <Image src="/IntelligentDoorLock.png" width={100} height={100}  layout="responsive" className="rounded cursor-pointer hover:shadow-md "></Image>
    ...
    Popular Products
      ...
      <div className="grid grid-cols-12 gap-4 bg-gray-100 p-5 ">
        ...
        <div className="col-span-10 md:col-span-8 grid lg:grid-cols-4 grid-cols-2 justify-evenly gap-5">
          ...
          <div className="col-span-1 bg-white p-4 rounded shadow-sm hover:cursor-pointer border hover:shadow-lg">
            <Image src="/Hardware02.jpg" width={200} height={150}></Image>
            {/* <StaticImage src="../ProductImages/Hardware02.jpg"></Static > */}
            <p className="text-sm text-gray-500 mb-3 h-10">
              {" "}
              Intelligent Door Lock N6700{" "}
            </p>
      ...
      <div className="grid grid-cols-12 bg-white p-5 ">
        ...
        <div className="col-span-10 md:col-span-8 grid md:grid-cols-3 grid-cols-1 gap-5">
          <div className="col-span-1">
            <Image src="/IndexPageImage01.png" width={150} height={150} className="w-full h-full cursor-pointer hover:shadow-md rounded" ></Image>
            {/* <StaticImage
          ...
          <div className="col-span-1">
          <Image src="/IndexPageImage02.png" width={150} height={150} className="w-full h-full cursor-pointer hover:shadow-md rounded" ></Image>
          ...
          <div className="col-span-1 bg-red text-white">
            <Image src="/IndexPageImage03.png" width={150} height={150} className="w-full h-full cursor-pointer hover:shadow-md rounded"></Image>
            {/* <StaticImage
