    ...
    <div className='w-full h-40 grid grid-cols-12 items-center px-5'>
      ...
      <div>
        <ol className='list-none flex space-x-2'>
         ...
         <Link href="/"><li className='flex items-center text-gray-500 hover:text-underline hover:cursor-pointer hover:text-primary'>Cart / </li></Link> 
          <li className='flex items-center text-gray-500 hover:text-underline hover:cursor-pointer hover:text-primary font-semibold'>Checkout</li>
        </ol>
      </div> 
        </div>
...
export default CheckoutNavTrail;