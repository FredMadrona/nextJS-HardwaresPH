        ...
        <div>
          <ol className="list-none flex space-x-2">
            <Link href="/home">
              {" "}
              <li
                className="flex items-center text-gray-500 hover:text-underline hover:cursor-pointer ho
        ver:text-primary"
              >
                Home /
              </li>{" "}
            </Link>
            <li className="flex items-center text-primary hover:text-underline hover:cursor-pointer ">
              {MenuItems}{" "}
            </li>
          </ol>
        </div>
