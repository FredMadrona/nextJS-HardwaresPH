...
const MobileBillingContent = ({ updateCart }) => {
    ...
    return (
        <div className="container max-w-screen-md mx-auto">
            ...
            {cartItems.map((item, index) => (
                <div key={index} className="flex items-center mb-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            <p className="text-gray-500">{item.name} x {item.quantity}</p>
            ...
            {subscribeSuccess && (
                <div
                    className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 bg-green-500 text-white rounded z-50">
